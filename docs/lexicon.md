...
TBD — crate naming will follow the 11-layer topology as implementation begins. Each crate name will pass the gnomon naming gate before architecture is finalized.
